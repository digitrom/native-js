...
//     console.log('create promise')
//     res()
//     setTimeout(function timer(){ // ведет свой отсчет в webApi, а в очередь попадает ,только когда прошло 3 сек!!!
//         console.log('timeout')},3000)
// }).then(()=> {// попадает в Microtasks
//     console.log('then')})
//
// b()
// c()
...
// new Promise(function (res,rej){
//     console.log(2)
//     res()// если промис зарезолвился медленнее, чем отсчитал setTimeout, то в очередь из webApi пер-ым попадет именно
//     //setTimeout, а это значит, что и на callstack попадет 1-ым, отработает.
// }).then(()=> {
//     console.log(3)
// })
//
