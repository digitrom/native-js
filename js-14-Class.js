...
//     this.brand = brand // и содаем св-во бренд
...
// нужно чтобы создавалась 1 функция для всех инстансов, поэтому нуджно записывать функцию в prototype:

// Car.prototype.startEngine = function() {
//     console.log(`${this.brand} is started`)
// }
//теперь каждый объект имеет ссылку на Car.prototype и там можно достучвться до этой функции - в памяти она создоется 1 раз
// car1.startEngine()
// car2.startEngine()
...
// class Car {
//     //{} опять - внутри Class-а при вызове через New создается новый объект и мы через this обращаемся к этому объекту и создаем инстанс
