...
// //globalLe { } --> null
// // это объект глобального лексического окружения, у него есть св-во со ссылкой на внешнее лексическое окружение,
...
// //2. (line 24) внутри startEngine() создастся ссылка  [[Environment]] и будет ссылаться на --> GlobalLE
...
//
// // 4. на 26 line выполняется код, где нужна переменная  car, кот-ая сначала ищется в локальном LE(в  scope  функции):
// // startEngineLE {} -  не находится, далее смотрит на код строчкой выше и видит ссылку --> GlobalLE,
// // и выйдет по этой ссылке на GlobalLE, а в данном объекте переменная car есть, поэтому он возьмёт оттуда и получим в консоли: "Start bmw"
// //
//
// //--------------------------------------------------------------------------------------
...
//
//
// //globalLE { } --> null // на момент старта скрипта -  данный объект пустой
...
// //startEngineLE {}
//     console.log(`Start ${car}`) // "startEngine is not defined "
// }
// //-----------------------------------------------------------------------------------------
...
// //[[Environment]] --> GlobalLE - создаться не сразу, а когда объявится функция (75 line)
// //startEngineLE {} // создаться на момент вызова (80 line)
//     console.log(`Start ${car}`)
// }
// startEngine()
//
...
//     console.log(`Start ${car}`)
// }
// startEngine(); // в консоли будет Start audi
//
// //======================================================================================================================
